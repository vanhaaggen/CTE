...
const text = {
    ...
    CAT: {
        ...
        sectionSchedule: {
            row1: {
                cell0: "9:30 - 10:30",
                cell1: <p className="crosstraining">CROSSTRAINING</p>,
                cell2: <p className="crosstraining">CROSSTRAINING</p>,
                cell3: <p className="crosstraining">CROSSTRAINING</p>,
                cell4: <p className="crosstraining">CROSSTRAINING</p>,
                cell5: <p className="crosstraining">CROSSTRAINING</p>,
                cell6: <p className="crosstraining">CROSSTRAINING</p>,
            },
            row2: {
                cell7: "10:30 - 11:30",
                cell9: <p className="crosstraining">CROSSTRAINING</p>,
                cell8: <p className="crosstraining">CROSSTRAINING</p>,
                cell10: <p className="crosstraining">CROSSTRAINING</p>,
                cell11: <p className="crosstraining">CROSSTRAINING</p>,
                cell12: <p className="crosstraining">CROSSTRAINING</p>,
                cell13: <p className="crosstraining">CROSSTRAINING</p>,
            },
            row3: {
                cell14: "11:30 - 15:15",
                cell15: <p className="openbox">OPEN BOX</p>,
                cell16: <p className="openbox">OPEN BOX</p>,
                cell17: <p className="openbox">OPEN BOX</p>,
                cell18: <p className="openbox">OPEN BOX</p>,
                cell19: <p className="openbox">OPEN BOX</p>,
                cell20: "",
            },
            row4: {
                cell21: "15:15 - 16:15",
                cell22: <p className="crosstraining">CROSSTRAINING</p>,
                cell23: <p className="crosstraining">CROSSTRAINING</p>,
                cell24: <p className="crosstraining">CROSSTRAINING</p>,
                cell25: <p className="crosstraining">CROSSTRAINING</p>,
                cell26: <p className="crosstraining">CROSSTRAINING</p>,
                cell27: "",
            },
            row5: {
                cell28: "16:30 - 17:30",
                cell29: <p className="crosstraining">CROSSTRAINING</p>,
                cell30: <p className="crosstraining">CROSSTRAINING</p>,
                cell31: <p className="crosstraining">CROSSTRAINING</p>,
                cell32: <p className="crosstraining">CROSSTRAINING</p>,
                cell33: <p className="crosstraining">CROSSTRAINING</p>,
                cell34: "",
            },
            row6: {
                cell35: "17:30 - 18:30",
            ...
            row7: {
                cell42: "18:30 - 19:30",
                cell43: <p className="crosstraining">CROSSTRAINING</p>,
                cell44: <p className="crosstraining">CROSSTRAINING</p>,
                cell45: <p className="crosstraining">CROSSTRAINING</p>,
                cell46: <p className="crosstraining">CROSSTRAINING</p>,
                cell47: <p className="crosstraining">CROSSTRAINING</p>,
                cell48: "",
            },
            row8: {
                cell49: "19:30 - 20:30",
                cell50: <p className="crosstraining">CROSSTRAINING</p>,
                cell51: <p className="crosstraining">CROSSTRAINING</p>,
                cell52: <p className="crosstraining">CROSSTRAINING</p>,
                cell53: <p className="crosstraining">CROSSTRAINING</p>,
                cell54: <p className="crosstraining">CROSSTRAINING</p>,
                cell55: "",
            },
            row9: {
                cell56: "20:30 - 21:30",
